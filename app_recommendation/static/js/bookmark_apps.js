...
var handleSweetNotification = function() {
    $('[data-click="swal-passive-user"]').click(function(e) {
        e.preventDefault();
        var link = $(this).attr('href');
            swal({
                title: "Are you sure to make this user passive?",
                text: "You are about to make selected User's status passive. After the process, this user will not login , do you want to proceed?",
                type: "error",
                showCancelButton: true,
                confirmButtonClass: 'btn-danger',
                confirmButtonText: 'Passive'
            },
            function(){
    ...
    $('[data-click="swal-passive"]').click(function(e) {
    e.preventDefault();
    var link = $(this).attr('href');
		swal({
			title: "Are you sure to make it passive?",
			text: "You are about to make selected feedback Train Status passive. After the process, this feedback will not included to train data, do you want to proceed?",
			type: "error",
			showCancelButton: true,
			confirmButtonClass: 'btn-danger',
			confirmButtonText: 'Passive'
    ...
    $('[data-click="swal-active-user"]').click(function(e) {
    e.preventDefault();
    var link = $(this).attr('href');
		swal({
			title: "Are you sure to activate this User ?",
			text: "You are about to make selected User's status active. After process this user can login, do you want to proceed?",
			type: "success",
			showCancelButton: true,
    ...
    $('[data-click="swal-active"]').click(function(e) {
        e.preventDefault();
        var link = $(this).attr('href');
            swal({
                title: "Are you sure to make it activate?",
                text: "You are about to make selected feedback Train Status active. After process this feedback will include to train data, do you want to proceed?",
                type: "success",
                showCancelButton: true,
                confirmButtonClass: 'btn-success',
                confirmButtonText: 'Active'
        ...
        $('[data-click="swal-danger-user"]').click(function(e) {
            e.preventDefault();
            var link = $(this).attr('href');
                swal({
...
$('[data-click="swal-danger-reset"]').click(function(e) {
    e.preventDefault();
    var link = $(this).attr('href');
...
function sorting(item, params) {                                                                                                                                                     
	console.log(item)                                                                                                                                                                                   
        sort_value = $(item).attr("data-value");                                                                                                                                                            
        if(params) {                                                                                                                                                                                        
            window.location.href = "./?" + params + "&order_by=" + sort_value;                                                                                                                                 
        }                                                                                                                                                                                                   
        else {                                                                                                                                                                                              
            window.location.href = "./?order_by=" + sort_value;                                                                                                                                                
        }                                                                                                                                                                                                   
     }
